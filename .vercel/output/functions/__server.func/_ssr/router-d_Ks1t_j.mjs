...
//#region node_modules/.nitro/vite/services/ssr/assets/router-d_Ks1t_j.js
var router_d_Ks1t_j_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CjhBOnW1.css";
var APP_NAME = "Pegbox";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Reference pitches for the six strings of a guitar in standard tuning."
			},
			{
				name: "theme-color",
				content: "#0c0c0d"
...
var $$splitComponentImporter = () => import("./routes-B_eLCsDM.mjs");
...
//#endregion
export { getRouter, router_d_Ks1t_j_exports as t };
